...
function search(db, query, { limit = 10, sinceDate = null, chunkType = null, minConfidence = null, includeStale = false, skipTracking = false } = {}) {
  let sql = `
...
module.exports = { SCHEMA, openDb, getFileMeta, deleteFileChunks, insertChunks, search, getAdjacentChunks, getStats, getAllFilePaths };
