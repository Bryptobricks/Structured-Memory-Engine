...
CREATE TABLE IF NOT EXISTS chunks (
  ...
  line_end INTEGER,
  entities TEXT,
  chunk_type TEXT DEFAULT 'raw',   -- v1: always 'raw'. v2 Retain: 'fact'|'opinion'|'experience'
...
function search(db, query, { limit = 10, sinceDate = null, chunkType = null, minConfidence = null } = {}) {
  let sql = `
