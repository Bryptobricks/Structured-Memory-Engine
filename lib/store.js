...
CREATE TABLE IF NOT EXISTS contradictions (
  ...
  FOREIGN KEY (chunk_id_old) REFERENCES chunks(id),
  FOREIGN KEY (chunk_id_new) REFERENCES chunks(id)
);
...
function search(db, query, { limit = 10, sinceDate = null, chunkType = null, minConfidence = null, includeStale = false } = {}) {
  let sql = `
...
module.exports = { SCHEMA, openDb, getFileMeta, deleteFileChunks, insertChunks, search, getAdjacentChunks, getStats };
