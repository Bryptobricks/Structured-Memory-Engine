...
if (command === 'index') {
  ...
  const result = runReflectCycle(db, { dryRun: args.dryRun || false, config, mode, workspace });
  ...
  if (result.entityPages && result.entityPages.generated > 0) {
    console.log(`  Entity pages: ${result.entityPages.generated} generated`);
  }
